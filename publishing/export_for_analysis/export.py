...
Regenerates every file in ``publishing/export_for_analysis/``:
...
Run:
    python publishing/export_for_analysis/export.py            # SAMPLE from repo fixtures
    python publishing/export_for_analysis/export.py --source firestore --dataset-root mainGame
"""
...
ANALYTICS_DIR = PUBLISHING_DIR / "data_analysis" / "analytics_v1"
